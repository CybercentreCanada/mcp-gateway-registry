...
| Ingress relay server allowlist | `EGRESS_INGRESS_RELAY_ALLOWED_SERVERS` | — | `registry.egressAuth.ingressRelayAllowedServers` | Whitespace-separated canonical server paths allowed to use `ingress_relay`. Empty denies all. |
